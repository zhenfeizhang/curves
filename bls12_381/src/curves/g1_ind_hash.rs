use ark_ec::hashing::curve_maps::ind::IndHashConfig;
use crate::g1::Config;
use crate::Fq;
...
mod test {
    use ark_ec::hashing::curve_maps::ind::IndHashConfig;
    use crate::{g1::Config, curves::tests::ind_hash_test_vectors::bls12_381_test};
    use ark_ff::MontFp;
    use itoa::Buffer;
    ...
    fn test_phi() {
        ...
        let res = <Config as IndHashConfig>::phi(&t1, &t2);
    ...
    fn test_eta() {
        ...
        let res = <Config as IndHashConfig>::eta(s);
        assert_eq!(res[0], t1);
        assert_eq!(res[1], t2);
    }
    ...
    fn test_h_prime() {
        ...
        let res = <Config as IndHashConfig>::h_prime(&[num0, num1, num2, den, t1, t2]);
        assert_eq!(x, res.x);
        assert_eq!(y, res.y);
    }
    ...
    fn test_map() {
        ...
        let res = <Config as IndHashConfig>::hash_to_curve_unchecked(s);
        assert_eq!(x, res.x);
        assert_eq!(y, res.y);
    ...
    fn check_test_vectors() {
        ...
        for i in 0..test_vectors.len() / 2 {
            ...
            let res = <Config as IndHashConfig>::hash_to_curve_unchecked(printed);
