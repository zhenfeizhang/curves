...
//     assert_eq!(
//         a,
//         BigInteger384([0x4067a038f0582e2a, 0x2f9480d7528a70b0, 0x91, 0x0,
// 0x0, 0x0])     );
// }
...
// #[test]
// fn test_fq_ordering() {
//     // BigInteger384's ordering is well-tested, but we still need to make
// sure the     // Fq elements aren't being compared in Montgomery form.
//     for i in 0..100 {
//         assert!(Fq::from(BigInteger384::from(i + 1)) >
// Fq::from(BigInteger384::from(i)));     }
// }
...
//     assert_eq!(a, Fq2::new(Fq::zero(), Fq::from(BigInteger384::from(2)),));
// // 2u
